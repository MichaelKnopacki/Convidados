...
public class GuestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //ViewHolder é o responsável por inflar as infos nas views
    ...
    private void handleSave(){
        ...
        int confirmation = 0; //NÃO CONFIRMADO
    ...
    // O View Holder guardar as views
    // Evitando o uso demasiado do findViewById()
